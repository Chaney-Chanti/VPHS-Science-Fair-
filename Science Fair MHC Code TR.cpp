...
int main()
{
	...
	for (outercounter = 0; outercounter < loopend; outercounter++)
	{
		...
		//Prints The Number of Protein Sequences Created By the Program
		cout << endl << "Number of Sequences Genrated:" << counter << endl << endl;
		dataresults[outercounter] = counter;
	}
	// end
	
	//Prints Permutations for n
